...
export const PARAM_META = {
  ...
  podium_floors: {
    ...
    layer: 'district_overlay',
    phase: 1,
    description: '기단부(포디움) 층수. 0 = 포디움 없음.',
  },
  podium_floor_height: {
    label: '포디움 층고',
    unit: 'm',
  ...
  podium_setback: {
    ...
    layer: 'district_overlay',
    phase: 1,
    description: '포디움 상부 타워의 측면(양쪽) 셋백 거리.',
  },
